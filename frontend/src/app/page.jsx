          ...
          <div className="card p-6">
            ...
            <div className="space-y-3">
              <FeatureItem
                ...
                text="PDF text extraction (instant processing)"
              />
              <FeatureItem
                icon={<CheckCircle className="w-4 h-4 text-green-500" />}
                text="OCR for images and scanned documents"
              />
              <FeatureItem
                icon={<CheckCircle className="w-4 h-4 text-green-500" />}
                text="Smart category prediction with learning"
              />
              <FeatureItem
                icon={<CheckCircle className="w-4 h-4 text-green-500" />}
                text="Confidence scoring and validation"
              />
              <FeatureItem
                icon={<CheckCircle className="w-4 h-4 text-green-500" />}
                text="Duplicate detection and export to CSV"
              />
            </div>
          </div>
        </div>
